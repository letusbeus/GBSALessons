...
public class Program {
     ...
     *      марка, модель, цвет, тип кузова, число колёс, тип топлива,
     *      тип коробки передач, объём двигателя;
     ...
     *      Провести проверку принципа SRP. // Прицнип единственной ответственности
     * 4. Расширить абстрактный класс «Car», добавить метод: включение противотуманных фар,
     *      перевозка груза. Провести проверку принципа OCP. // Принцип открытости-закрытости
